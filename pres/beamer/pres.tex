...
\frame{
    ...
    \itemize{
        \item Definición del poryecto en el cliente
        \item Automatización de creación de proyectos desconectados
        \item Servidor estático
...
\frame{
    \frametitle{Sincronización - Objetivos}
    \begin{itemize}
        \item Creación
...
\frame{
    ...
    \begin{itemize}
        ...
        \item {\bf UPDATE}\par
            Enviar y recibir, resolver conflictos
            
        \item \textit{\bf PURGE}\par
            Elminar entidades inactivas
    \end{itemize}
}
