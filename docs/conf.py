...
project = u'Sistemas Web Desconectados'
copyright = u'2009, van Haaster, Diego; Marcos; Defossé, Nahuel'
...
htmlhelp_basename = 'SistemasWebDesconectadosdoc'
...
latex_documents = [
  ('index', 'SistemasWebDesconectados.tex', u'Sistemas Web Desconectados',
