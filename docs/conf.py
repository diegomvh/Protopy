# -*- coding: utf-8 -*-
#
# Sistemas Web Desconectados documentation build configuration file, created by
# sphinx-quickstart on Sat Aug  8 20:07:39 2009.
#
...
project = u'Aplicaciones Web Desconectadas'
copyright = u'2009, Defossé, Nahuel; van Haaster, Diego; Marcos' # Orden alfabético
...
try:
    from subprocess import Poepn, PIPE
    release = Popen("hg id -n".split(' '), stdout=PIPE).communicate()[0].strip()
except:
    release = '1'
else:
    relsease = str(release)
...
# the title page.
latex_logo = '_static/nasa_django_logo.png'
