...
\lstdefinestyle{javascript}{
  keywords={catch,throw,try,finally,break,continue,do,for,import,new,this,void,case,default,else,function,in,return,typeof,while,comment,delete,export,if,label,switch,var,with}
...
de un módulo management.commands.nombre_comando, en el cual se extiende 
