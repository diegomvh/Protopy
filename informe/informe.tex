...
En un módulo se define un conjunto de símbolos.
Un símbolo puede ser
\begin{itemize}
  \item Definición de una función
  \item Definición de una variable
  \item Definición de una expresión lambda
  \item Importación de otro módulo
\end{itemize}
}
Un módulo puede ser cargado desde el intérprete interactivo o desde otro módulo a través de 
la sentencia \emph{import}
\begin{verbatim}
import os
\end{verbatim}
Al ejecutrse esta sentencia, el intérprete buscará secuencialmente en el PYTHONPATH un módulo llamado os, 
...
se cargará de unicamente una vez, en otras palabras, existe una única instancia de un módulo.
...
mitigar este problma, puede definirse el símbolo \_\_all\_\_ al comienzo del módulo, con una tupla
en la cual se definen los símbolos que se desean exportar. Por ejemplo:
