...
var DatabaseIntrospection = Class('DatabaseIntrospection', BaseDatabaseIntrospection, {
     ...
     */
    get_table_list: function(cursor) {
     ...
     */
    get_indexes: function(cursor, table_name) {
        var indexes = {};
    ...
    _table_info: function(cursor, name) {
