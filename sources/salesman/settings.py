...
DATABASE_NAME = 'db/db.sqlite'            # Or path to database file if using sqlite3.
...
SECRET_KEY = 't7*tzyilw2-oxpy5rwmb+3)oks8kq0(cp^idca0zuhvqvh!-c1'
...
MIDDLEWARE_CLASSES = (
    ...
    'offline.middleware.threadlocals.ThreadLocals',
)
...
TEMPLATE_CONTEXT_PROCESSORS = (
    ...
    'offline.context_processors.offline',
