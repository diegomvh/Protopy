...
function linebreak_iter(template_source) {
/*    yield 0
...
function get_safe_settings() {
    ...
    var settings_dict = {};
    for each (var k in dir(settings))
        if k.isupper():
...
function technical_500_response(request, exc_type, exc_value, tb) {
/*
...
function technical_404_response(request, exception) {
...
*/
    var t = new Template(TECHNICAL_404_TEMPLATE, 'Technical 404 template');
    var c = new Context({});
        ...
        'settings': get_safe_settings(),*/
    return new HttpResponseNotFound(t.render(c), { mimetype: 'text/html' });
}

function empty_urlconf(request) {
    /*Create an empty URLconf 404 error response.*/
    t = new Template(EMPTY_URLCONF_TEMPLATE, 'Empty URLConf template');
    c = new Context({});
        /*'project_name': settings.SETTINGS_MODULE.split('.')[0];*/
    return new HttpResponse(t.render(c), {mimetype:'text/html'});
}
...
var TECHNICAL_500_TEMPLATE = (<r><![CDATA[<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN" "http://www.w3.org/TR/html4/loose.dtd">
<html lang="en">
<head>
...
var TECHNICAL_404_TEMPLATE = (<r><![CDATA[<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN" "http://www.w3.org/TR/html4/loose.dtd">
<html lang="en">
<head>
  <meta http-equiv="content-type" content="text/html; charset=utf-8">
...
var EMPTY_URLCONF_TEMPLATE = (<r><![CDATA[<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN" "http://www.w3.org/TR/html4/loose.dtd">
<html lang="en"><head>
  <meta http-equiv="content-type" content="text/html; charset=utf-8">
...
publish({
    TECHNICAL_500_TEMPLATE: TECHNICAL_500_TEMPLATE,
    TECHNICAL_404_TEMPLATE: TECHNICAL_404_TEMPLATE,
    EMPTY_URLCONF_TEMPLATE: EMPTY_URLCONF_TEMPLATE,
    technical_404_response: technical_404_response
});